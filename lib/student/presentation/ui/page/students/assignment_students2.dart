...
class HomeWorkStudentsScreen2 extends StatefulWidget {
  @override
  State<HomeWorkStudentsScreen2> createState() => _HomeWorkStudentsState();
}

class _HomeWorkStudentsState extends State<HomeWorkStudentsScreen2> {
                  ...
                  child: Container(
                    ...
                    child: TextButton(
                      onPressed: () {
                        ...
                        print(grade);
                        setState(() {
                          students[index].stateHomeWork = grade
                              .toString(); // تحديث درجة الطالب باستخدام الفهرس
                        });
                        Navigator.of(context).pop(); // إغلاق الـ dialog
                      },
                      child: Text(
        ...
        return Scaffold(
            ...
            body: Column(
              children: [
                ...
                WidgetTitleList(page: "assignment"),
            ...
            floatingActionButton: students.any(
                    (student) => !student.stateHomeWork.contains("غير مسلم"))
                ? FloatingActionButton(
                    onPressed: () {
                      List<StudentActivityClass> studentsWithDegree = students
                          .where((student) =>
                              !student.stateHomeWork.contains("غير مسلم"))
                          .toList();
